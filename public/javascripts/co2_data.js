...
async function draw_chart(context, data) {
...
async function postFilterDate() {
    ...
    const response = await fetch('/co2/graph', {
    ...
    await response.json().then( (data) => {
        ...
        var ctx = document.getElementById('co2_chartCanvasFiltered').getContext('2d');
        var data =  {
